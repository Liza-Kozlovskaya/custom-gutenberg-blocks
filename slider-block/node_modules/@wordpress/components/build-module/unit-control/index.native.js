...
function UnitControl(_ref) {
  ...
  var onPickerPresent = useCallback(function () {
  ...
  var renderUnitButton = useMemo(function () {
    var unitButton = createElement(View, {
  ...
  var getAnchor = useCallback(function () {
  ...
  var renderUnitPicker = useCallback(function () {
