...
function Button(props, forwardedRef) {
  var _useContextSystem = useContextSystem(props, 'Button'),
      ...
      otherProps = _objectWithoutProperties(_useContextSystem, ["children", "className", "currentColor", "icon", "isActive", "isControl", "isSubtle", "onClick", "size", "variant", "describedBy"]);
