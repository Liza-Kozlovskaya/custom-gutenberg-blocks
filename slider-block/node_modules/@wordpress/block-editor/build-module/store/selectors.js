 ...
 */
import { castArray, flatMap, first, isArray, isBoolean, last, map, reduce, some, find, filter, mapKeys, orderBy, every } from 'lodash';
...
var __experimentalGetParsedPatterns = createSelector(function (state) {
...
export var __experimentalGetAllowedPatterns = createSelector(function (state) {
  ...
  var patternsAllowed = filter(patterns, function (_ref11) {
    var contentBlocks = _ref11.contentBlocks;
    return every(contentBlocks, function (_ref12) {
