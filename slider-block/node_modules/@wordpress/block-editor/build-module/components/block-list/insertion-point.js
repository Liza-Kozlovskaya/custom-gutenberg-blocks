...
function InsertionPointPopover(_ref2) {
  ...
  return createElement(Popover, {
    ...
    className: className,
    style: style
  }, !isHidden && (showInsertionPoint || isInserterShown || isInserterForced) && createElement("div", {
    className: "block-editor-block-list__insertion-point-indicator"
  }), !isHidden && (isInserterShown || isInserterForced) && createElement(InsertionPointInserter, {
    rootClientId: rootClientId,
