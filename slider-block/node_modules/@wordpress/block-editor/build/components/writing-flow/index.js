 ...
 */
var SelectionStart = (0, _element.createContext)();
...
function selector(select) {
  ...
  return {
    ...
    firstBlock: (0, _lodash.first)(blocks),
    lastBlock: (0, _lodash.last)(blocks),
...
function WritingFlow(_ref) {
  ...
  var onSelectionStart = (0, _useMultiSelection.default)(container);
  ...
  function onMouseDown(event) {
    ...
    if (isNavigationMode && selectedBlockClientId && (0, _dom2.isInsideRootBlock)((0, _dom2.getBlockDOMNode)(selectedBlockClientId, ownerDocument), event.target)) {
  ...
  function onKeyDown(event) {
    ...
    var isNavEdge = isVertical ? _dom.isVerticalEdge : _dom.isHorizontalEdge;
    ...
    if (selectedBlockClientId) {
      if (isTab) {
        var wrapper = (0, _dom2.getBlockDOMNode)(selectedBlockClientId, ownerDocument);
        ...
        if (isShift) {
          ...
          var tabbables = _dom.focus.tabbable.find(wrapper);

          var lastTabbable = (0, _lodash.last)(tabbables) || wrapper;
  ...
  return (0, _element.createElement)(SelectionStart.Provider, {
