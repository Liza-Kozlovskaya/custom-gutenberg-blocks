		...
		V = {
			...
			eventsEmitter: {
				...
				offAny: function ( e ) {
					...
					return (
						t >= 0 && this.eventsAnyListeners.splice( t, 1 ), this
					);
				},
				off: function ( e, t ) {
					var i = this;
						...
						l.forEach( function ( e ) {
							if (
								( s.eventsAnyListeners &&
									...
									s.eventsAnyListeners.forEach( function (
										s
									) {
			...
			update: {
				...
				updateProgress: function ( e ) {
					if ( void 0 === e ) {
						...
						e =
							( this && this.translate && this.translate * t ) ||
							0;
					}
					var i = this.params,
			...
			slide: {
				slideTo: function ( e, t, i, s ) {
					...
					var f = Math.min( r.params.slidesPerGroupSkip, n ),
						v =
							f +
							Math.floor( ( n - f ) / r.params.slidesPerGroup );
				...
				slideToClosest: function ( e, t, i, s ) {
					...
					var a = this.activeIndex,
						...
						n =
							r +
							Math.floor(
								( a - r ) / this.params.slidesPerGroup
							),
						l = this.rtlTranslate
							? this.translate
							: -this.translate;
			...
			manipulation: {
				appendSlide: function ( e ) {
					...
					i.loop && this.loopCreate(),
						( i.observer && this.support.observer ) ||
							this.update();
				},
				prependSlide: function ( e ) {
					...
					t.loop && this.loopCreate(),
						( t.observer && this.support.observer ) ||
							this.update(),
						this.slideTo( a, 0, ! 1 );
				},
					...
					if ( n && ( ! n || 0 !== Object.keys( n ).length ) ) {
						...
						if ( l && this.currentBreakpoint !== l ) {
							...
							var u = d.direction && d.direction !== a.direction,
								c =
									a.loop &&
									( d.slidesPerView !== a.slidesPerView ||
										u );
					...
					if ( e.centeredSlides ) {
						for (
							...
							t[ o ] &&
								! n &&
								( ( r += 1 ),
								( l += t[ o ].swiperSlideSize ) > s &&
									( n = ! 0 ) );
						for ( var d = a - 1; d >= 0; d -= 1 )
							t[ d ] &&
								! n &&
								( ( r += 1 ),
								( l += t[ d ].swiperSlideSize ) > s &&
									( n = ! 0 ) );
					} else
	...
	var U = {
			...
			enableDraggable: function () {
				if ( this.params.scrollbar.el ) {
					var e = r(),
						...
						l = t.$el[ 0 ],
						o = ! (
							! n.passiveListener || ! a.passiveListeners
						) && { passive: ! 1, capture: ! 1 },
						d = ! (
							! n.passiveListener || ! a.passiveListeners
						) && { passive: ! 0, capture: ! 1 };
		...
		te = {
			...
			load: function () {
				...
				if (
					...
					t.children( '.' + i.slideVisibleClass ).each( function (
						t
					) {
						var i = r
		...
		le = {
			...
			setTransition: function ( e ) {
				var t = this,
					...
					s = t.$wrapperEl;
				if (
					( i.transition( e ), t.params.virtualTranslate && 0 !== e )
				) {
					var a = ! 1;
					...
					if (
						...
						0 === C.length &&
							...
							0 === S.length &&
								...
								f.append( S ) ),
							C.length &&
								( C[ 0 ].style.opacity = Math.max( -y, 0 ) ),
							S.length &&
								( S[ 0 ].style.opacity = Math.max( y, 0 ) );
					}
				}
				if (
					( i.css( {
					...
					if (
						...
						0 === d.length &&
							...
							0 === h.length &&
								...
								s.append( h ) ),
							d.length &&
								( d[ 0 ].style.opacity = Math.max( -a, 0 ) ),
							h.length &&
					...
					if (
						...
						0 === C.length &&
							...
							0 === S.length &&
								...
								u.append( S ) ),
							C.length &&
								( C[ 0 ].style.opacity = f > 0 ? f : 0 ),
							S.length &&
								( S[ 0 ].style.opacity = -f > 0 ? -f : 0 );
					}
				}
			},
			setTransition: function ( e ) {
		...
		ue = [
			...
			},
			{
				...
				create: function () {
					M( this, {
						pagination: t( { dynamicBulletIndex: 0 }, Z ),
					} );
				},
				on: {
					init: function ( e ) {
			...
			},
			{
				...
				create: function () {
					M( this, {
						hashNavigation: t( { initialized: ! 1 }, re ),
					} );
				},
				on: {
					init: function ( e ) {
