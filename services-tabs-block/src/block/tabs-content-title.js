( function( blocks, editor, i18n, element, components, _ ) {
    ...
    blocks.registerBlockType( 'create-block/services-tabs-title-block', {
        title: __( 'Title in tabs content', 'services-tabs-block' ),
        icon: 'category',
        category: 'senla-tabs-block',
        parent: ['create-block/block-tabs-content'],
        attributes: {
            tabs__info_title: {
                type: 'string',
