...
import { BottomSheet, ColorSettings, FocalPointSettings, LinkPickerScreen } from '@wordpress/components';
...
function BottomSheetSettings(_ref) {
  ...
  return createElement(BottomSheet, _extends({
    ...
    fullScreen: true
  }, createElement(FocalPointSettings, null)), createElement(BottomSheet.NavigationScreen, {
