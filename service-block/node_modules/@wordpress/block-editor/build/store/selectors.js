...
var __experimentalGetParsedPatterns = (0, _rememo.default)(function (state) {
  var patterns = state.settings.__experimentalBlockPatterns;
  return (0, _lodash.map)(patterns, function (pattern) {
    return _objectSpread(_objectSpread({}, pattern), {}, {
      contentBlocks: (0, _blocks.parse)(pattern.content)
    });
  });
}, function (state) {
...
var __experimentalGetAllowedPatterns = (0, _rememo.default)(function (state) {
  ...
  var patterns = __experimentalGetParsedPatterns(state);

  if (!rootClientId) {
    return patterns;
  }

  var patternsAllowed = (0, _lodash.filter)(patterns, function (_ref11) {
    var contentBlocks = _ref11.contentBlocks;
    return (0, _lodash.every)(contentBlocks, function (_ref12) {
